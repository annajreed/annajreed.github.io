...
function chooseColor(depth){
  if (depth < 5) return "#e5fff7";
  else if (depth < 10) return "#66ffcc";
  else if (depth < 20) return "#1affb2";
  else if (depth < 30) return "#00b377";
  else if (depth < 50) return "#004d33";
  else return "#001a11";
}
